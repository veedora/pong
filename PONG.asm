...
;       Check if the ball is colliding with the right paddle
		...
		JNG EXIT_COLLISION  ;if there's no collision then exit
		
		MOV AX,PADDLE_RIGHT_X
		ADD AX,PADDLE_WIDTH
		CMP BALL_X,AX
		JNL EXIT_COLLISION  ;if there's no collision then exit
